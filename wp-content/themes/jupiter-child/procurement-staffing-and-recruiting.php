...
<!--hero-->
<section
        class="pt-[58px] pb-[48px] xl:pt-0 xl:pb-0 bg-center bg-cover bg-no-repeat xl:min-h-[480px] xl:flex xl:flex-col xl:justify-center xl:items-center bg-position-[center_top]"
