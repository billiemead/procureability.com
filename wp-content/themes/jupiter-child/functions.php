...
if (!function_exists('is_transparent_header')) {
    function is_transparent_header()
    {
        ...
        $pages_slug = array('analytics-insights', 'analytics-insights', 'intelligence-insights', 'consulting-insights', 'staffing-insights', 'recruiting-insights', 'procurement-organizations-of-the-future', 'thank-you-digital', 'thank-you', 'request-a-resource');
