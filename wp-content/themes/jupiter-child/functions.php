...
if (!function_exists('is_transparent_header')) {
    function is_transparent_header()
    {
        ...
        $pages_slug = array('analytics-insights', 'analytics-insights', 'intelligence-insights', 'consulting-insights', 'staffing-insights', 'recruiting-insights', 'thank-you-digital', 'thank-you', 'hire-a-temporary-resource', 'video', 'privacy-policy', 'contact', 'subscribe', 'about', 'diversity-equity-inclusion', 'procurement-staffing-and-recruiting');
