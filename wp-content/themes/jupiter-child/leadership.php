    ...
    <div class="max-w-[930px] px-[15px] mx-auto">
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-[30px]">
            <?php while ($leadership->have_posts()) : $leadership->the_post(); ?>
                ...
                >
                    <div class="pb-[100%] lg:pb-0 lg:w-[290px] lg:h-[290px] lg:rounded-full overflow-hidden mx-auto mb-[30px] lg:mb-[15px] relative">
                        <div class="absolute inset-0 bg-cover"
                             style="background-image: url('<?= get_the_post_thumbnail_url(); ?>')"></div>
                        <div class="lg:rounded-full absolute inset-0 group-hover:duration-[1s] group-hover:opacity-100 opacity-0 transition-all duration-[.3s] bg-[rgba(247,148,31,.68)]"></div>
