...
<?php get_header(); ?>
    ...
    <div class="theme-styles-overwrite text-[#393A40]">
        ...
        <section class="pt-[58px] pb-[48px] lg:py-[107px] bg-center bg-cover bg-no-repeat"
            ...
            <div class="md:max-w-[636px] lg:max-w-[1010px] mx-auto px-[33px] md:px-0">
                <div class="mb-[24px] lg:mb-[32px] text-center">
                    <span class="text-[22px] leading-[1.2] font-[500] md:text-[32px] md:leading-[1.27] lg:text-[40px] lg:leading-[1.3] lg:font-[600] text-white"><?= get_field('hero_text') ?></span>
                </div>
        ...
        <!--top content-->
        <section class="pt-[32px] pb-[40px] md:pt-[40px] md:pb-[48px] lg:pt-[95px] lg:pb-[100px]">
            <div class="px-[33px] lg:px-0 md:max-w-[636px] lg:max-w-[1180px] mx-auto grid gap-[32px] md:gap-[40px] lg:gap-[90px]">
                ...
                <?php if ($top_content_groups) : ?>
                    <?php foreach ($top_content_groups as $key => $top_content_group) : ?>
                        <div class="lg:flex lg:items-center lg:justify-between">
                            <div class="lg:w-[calc((555/1180)*100%)] <?php if ($key % 2 !== 0) : ?>lg:order-2<?php endif; ?>">
                                <div class="text-[18px] leading-[1.3] font-[500] md:text-[20px] md:leading-[1.27] lg:text-[28px] lg:leading-[36px] lg:font-[600] mb-[16px]">
                                    <?= $top_content_group['title']; ?>
                                </div>
                                <div class="[&_p]:text-[14px] [&_p]:leading-[1.7] opacity-[.8] md:opacity-100 [&_p]:lg:text-[18px] [&_p]:lg:leading-[1.6] [&_p]:lg:opacity-100">
                                    <?= $top_content_group['text']; ?>
                                </div>
                            </div>
                            <div class="lg:w-[calc((540/1180)*100%)] <?php if ($key % 2 !== 0) : ?>lg:order-1<?php endif; ?>">
                                <div class="pb-[66.56%] md:pb-[39.37%] lg:pb-[66.67%] w-full relative">
        ...
        <section class="py-[32px] bg-[#0098AE] relative bg-cover bg-center bg-no-repeat"
            ...
            <div class="relative px-[33px] md:px-0 md:max-w-[636px] lg:max-w-[1200px] mx-auto">
                <div class="lg:flex lg:items-center lg:justify-between">
                    <div class="lg:w-[calc((478/1200)*100%)] mb-[24px] lg:mb-0">
                        <div class="text-[24px] leading-[1.3] font-[500] mb-[16px] md:text-[34px] md:leading-[1.47] text-center lg:text-[33px] lg:leading-[1.38] lg:font-[600] lg:!text-left text-white lg:mb-[24px] lg:max-w-[368px]"><?= get_field('form_title'); ?></div>
                        <?php $form_list = get_field('form_list'); ?>
                        <?php if ($form_list) : ?>
                            <ul class="list-none ml-0 text-[14px] leading-[1.7] text-white lg:text-[18px] lg:leading-[1.6] lg:opacity-90 mb-0 space-y-[12px]">
                    ...
                    <div class="lg:w-[calc((555/1200)*100%)] mb-[-64px]">
                        <div id="form"
                             class="relative bg-white w-full md:rounded-[6px] shadow-[0px_3px_20px_rgba(57,58,64,0.1)] py-[32px] px-[35px] md:pt-[40px] md:pb-[48px] md:px-[78px] lg:px-[54px] lg:pt-[50px] lg:pb-[46px] box-border">
                            <?php $form_name = get_field('form_name'); ?>
                            <?php if ($form_name) : ?>
                                <div class="text-[16px] md:text-[18px] lg:text-[20px] leading-[1.5] font-[500] lg:opacity-80 mb-[32px] text-center"><?= $form_name; ?></div>
                            <?php endif; ?>
        ...
        <!--quote-->
        <section class="pt-[64px] pb-[40px] md:pt-[80px] md:pb-[48px] lg:pt-[110px] lg:pb-[88px] bg-[#F7F9FA]">
            <div class="px-[33px] lg:px-[0] md:max-w-[636px] lg:max-w-[1180px] mx-auto">
                <div class="lg:flex lg:justify-around lg:items-center">
                    <div class="md:max-w-[452px] lg:msx-w-auto md:mx-auto lg:mx-0 lg:w-[calc((452/1180)*100%)] mb-[16px] md:mb-[31px] lg:mb-0">
                        <div class="text-center lg:!text-left">
                            <span class="text-[24px] leading-[1.27] font-[500] md:text-[26px] md:leading-[1.47] lg:text-[34px] lg:leading-[1.5] lg:font-[600] text-[#00A2B7] brand-text-gradient text-transparent bg-clip-text"><?= get_field('quote_title'); ?></span>
                        </div>
                    </div>
                    <div class="lg:w-[calc((575/1180)*100%)]">
                        <div class="pb-[16px] lg:pt-[14px] text-center md:!text-left md:max-w-[480px] lg:max-w-none md:mx-auto lg:pl-[64px]  md:pb-[33px] lg:max-w-auto lg:mx-0 lg:pr-[59px] lg:pl-[68px] lg:pb-[20px] lg:text-left relative box-border">
                            <svg class="hidden md:block absolute md:top-[-12px] lg:top-[8px] md:left-[-38px] lg:left-[22px] w-[30px] h-auto"
                            ...
                            <svg class="hidden md:block absolute md:bottom-[30px] lg:bottom-[20px] md:right-[0px] md:right-[50px] lg:right-[110px] w-[30px] h-auto"
                                 xmlns="http://www.w3.org/2000/svg"
                                 width="40"
                            ...
                            <p class="!text-[14px] !leading-[1.65] !tracking-[-0.01em] md:!text-[16px] md:!leading-[1.7] lg:!text-[18px] lg:!leading-[1.6] lg:!tracking-normal opacity-[.8] mb-[0] before:content-['“'] after:content-['”'] md:before:content-none md:after:content-none"><?= wp_strip_all_tags(get_field('quote_content')); ?></p>
                        </div>

                        <div class="lg:pr-[40px] lg:pl-[70px]">
        ...
        <!--analytics-->
        <section class="pt-[32px] pb-[40px] md:pt-[40px] md:pb-[48px] lg:pt-[85px] lg:pb-[88px]">
            <div class="px-[33px] lg:px-0 max-w-[1180px] mx-auto">
                <div class="max-w-[404px] mx-auto mb-[16px] lg:mb-[40px]">
                    <div class="lg:flex lg:justify-center lg:items-center">
                        <div class="mb-[8px] lg:mb-0 lg:mr-[24px]">
                            <img class="block mx-auto lg:mx-0 md:w-[100px] lg:w-[95px]"
                                 src="<?= get_field('analytics_logo')['url']; ?>"
                                 alt="">
                        </div>
                        <div class="text-center lg:text-left">
                            <span class="brand-text-gradient text-transparent bg-clip-text text-[24px] leading-[1.47] font-[500] md:text-[26px] lg:text-[34px] lg:leading-[1.27] font-[600]"><?= get_field('analytics_title'); ?></span>
                        </div>
                    </div>
                </div>
                <div class="md:max-w-[603px] lg:max-w-[770px] mx-auto mb-[24px] md:mb-[32px] lg:mb-[40px] text-center lg:text-left">
                    <p class="text-[14px] opacity-[.8] lg:text-[16px] leading-[1.7] lg:opacity-100 mb-0">
                        <?= wp_strip_all_tags(get_field('analytics_content')); ?></p>
                </div>
                <div class="md:max-w-[636px] lg:max-w-[907px] mx-auto">
                    <div class="rounded-[5px] lg:rounded-[10px] border border-solid border-[#0098AE] overflow-hidden">
                        <div class="bg-[rgba(0,152,174,.1)] py-[25px] px-[40px] md:px-[58px] md:py-[16px] lg:py-[20px] lg:px-[46px] text-[16px] leading-[1.47] md:text-[20px] lg:text-[21px] lg:leading-[1.68] font-[500] text-center">
                            <?= get_field('analytics_list_title'); ?>
                        </div>
                        <?php $analytics_list = get_field('analytics_list'); ?>
                        <?php if ($analytics_list) : ?>
                            <ul class="pt-[24px] px-[47px] pb-[40px] md:pt-[36px] md:pb-[32px] md:px-[38px] lg:pt-[34px] lg:px-[60px] lg:pb-[42px] list-none lg:flex lg:flex-wrap [&_li:nth-child(odd)]:lg:w-[341px] [&_li:nth-child(even)]:lg:w-[399px] lg:justify-around m-0 text-[14px] leading-[1.4] md:text-[16px] lg:text-[18px] lg:leading-[2.1] space-y-[8px] md:space-y-[16px] lg:space-y-0 box-border">
                                <?php foreach ($analytics_list as $analytics_list_item) : ?>
                                    <li class="relative pl-[28px] ml-0 box-border">
                                        <svg class="absolute left-[5px] top-[6px] lg:left-0 lg:top-[11px] w-[12px] lg:w-[17px] h-auto"
        ...
        <!--benefits-->
        <section class="bg-[#F7F9FA] pt-[32px] pb-[39px] lg:pt-[123px] lg:pb-[117px]">
            <div class="px-[33px] lg:px-0 md:max-w-[464px] lg:max-w-[1084px] mx-auto">
                <div class="relative">
                    <div class="hidden lg:block [&_div]:absolute [&_div]:right-[50%] [&_div]:top-[50%] [&_div]:translate-x-[50%] [&_div]:translate-y-[-50%] [&_div]:border [&_div]:border-solid [&_div]:border-[#01738C] [&_div]:rounded-full [&_div]:opacity-[.1]">
                        <div class="h-[633px] w-[633px]"></div>
                        <div class="h-[461px] w-[461px]"></div>
                        <div class="h-[293px] w-[293px]"></div>
                    </div>
                    <div class="lg:absolute lg:right-[50%] lg:top-[50%] lg:translate-x-[50%] lg:translate-y-[-50%] text-center mb-[25px] lg:mb-0">
                        <div class=" mb-[8px] lg:mb-0">
                            <span class="brand-text-gradient text-transparent bg-clip-text text-[24px] font-[500] lg:text-[34px] leading-[1.27] lg:font-[600]"><?= get_field('benefits_title'); ?></span>
                        </div>
                    ...
                    <?php if ($benefits_list) : ?>
                        <ul class="relative grid gap-y-[12px] md:gap-y-[10px] lg:grid-cols-[386px_386px] lg:gap-x-[312px] lg:gap-y-[24px] list-none m-0">
                            <?php foreach ($benefits_list as $key => $benefits_list_item) : ?>
                                <li class="wow fadeIn h-[67px] md:h-[75px] lg:w-[386px] lg:h-[90px] rounded-[100px] border border-solid border-[rgba(1,115,140,0.3)] bg-white flex justify-center items-center text-center py-[20px] px-[26px] box-border m-0 relative <?php if (in_array($key, array(2, 6))) {
                                    echo 'lg:left-[-43px]';
                                    ...
                                    <span class="[&_br]:lg:hidden text-[14px] leading-[1.4] md:text-[16px] md:leading-[1.3] lg:text-[18px] lg:leading-[1.4] font-[500] lg:font-[400]"><?= $benefits_list_item['item']; ?></span>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    <?php endif; ?>
        ...
        <!--bottom content-->
        <section class="pt-[32px] pb-[48px] md:pt-[40px] lg:py-[83px] relative">
            <img class="hidden lg:block absolute top-[-75px] left-0"
                 src="<?= get_stylesheet_directory_uri(); ?>/page-digital-services/triangles-bg.svg" alt="">
            <div class="relative px-[33px] lg:px-0 md:max-w-[646px] lg:max-w-[1200px] mx-auto grid gap-[48px] lg:gap-[107px]">
                <div>
                    <div class="max-w-[1069px] mx-auto text-center mb-[24px] md:mb-[20px] lg:mb-[32px]">
                        <div class="[&_p]:text-[14px] [&_p]:leading-[1.7] [&_p]:md:text-[18px] [&_p]:md:leading-[1.6] lg:opacity-80">
                            <?= get_field('bottom_content_top_text'); ?></div>
                    </div>
                    <div class="md:max-w-[527px] lg:max-w-[655px] mx-auto text-center text-[18px] leading-[1.47] font-[500] mb-[16px] md:mb-[24px] md:text-[20px] md:leading-[1.4] lg:text-[22px] font-[600] lg:mb-[40px]">
                        <?= get_field('bottom_content_title'); ?>
                    </div>
                    <?php $bottom_content_list = get_field('bottom_content_list'); ?>
                    <?php if ($bottom_content_list) : ?>
                        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-[12px] md:gap-x-[36px] md:gap-y-[10px] lg:gap-[20px]">
                            <?php foreach ($bottom_content_list as $key => $bottom_content_list_item) : ?>
                                <div class="wow fadeIn py-[22px] px-[19px] rounded-[5px] md:rounded-[3px] border border-solid border-[rgba(0,152,174,0.4)] flex items-center justify-center text-center h-[72px] lg:h-[80px] box-border bg-white"
                                     data-wow-delay="<?= $key * 0.05; ?>s" data-wow-duration="2s">
                                    <span class="text-[14px] leading-[1.3] md:text-[16px] lg:text-[18px] font-[500]">
                ...
                <?php if ($bottom_content_group) : ?>
                    <div class="grid gap-[32px] lg:gap-[100px]">
                        <?php foreach ($bottom_content_group as $key => $bottom_content_group_item) : ?>
                            <div>
                                <div class="lg:flex lg:items-center lg:justify-between">
                                    <div class="mb-[24px] lg:mb-0 lg:w-[calc((524/1200)*100%)] <?= ($key % 2 !== 0) ? 'lg:order-2' : null; ?>">
                                        <div class=" text-[24px] font-[500] mb-[16px] lg:text-[34px] leading-[1.47] lg:font-[600] lg:mb-[24px] <?= ($key % 2 !== 0) ? 'text-[#F6881B]' : 'text-[#3BA17C]'; ?>">
                                            <?= $bottom_content_group_item['title']; ?>
                                        </div>
                                        <div class="[&_p]:text-[14px] [&_p]:lg:text-[18px] [&_p]:leading-[1.6] [&_a]:font-[600] [&_a]:lg:font-[500] [&_a]:!underline [&_a]:!decoration-[transparent] [&_a]:!transition-all [&_a]:!duration-200 [&_a]:!decoration-[#3BA17C] hover:[&_a]:!no-underline [&_a]:!decoration-dotted [&_a]:!font-poppins [&_a]:!underline-offset-[7px]">
                                    ...
                                    <?php if ($bottom_content_group_item_list) : ?>
                                        <div class="lg:w-[calc((572/1200)*100%)] <?= ($key % 2 == 0) ? 'lg:order-1' : null; ?>">
                                            <div class="relative">
                                                <div class="hidden lg:block absolute inset-0 bg-center bg-auto bg-no-repeat "
                                                ...
                                                <ul class="py-[7px] lg:py-0 relative rounded-[5px] border border-solid border-[rgba(59,161,124,0.4)] text-[14px] md:text-[16px] lg:text-[18px] lg:border-0 list-none text-[18px] font-[500] lg:font-[600] leading-[1.2] m-0 <?= ($key % 2 == 0) ? 'text-[#3BA17C] border-[rgba(59,161,124,0.4)]' : 'text-[#F6881B] border-[rgba(246,136,27,0.4)]'; ?>">
                                                    <?php foreach ($bottom_content_group_item_list as $bottom_content_group_item_list_item) : ?>
                                                        <li class="py-[20px] px-[10px] border-b last:border-0 border-solid lg:border-0 text-center lg:!text-left ml-0 lg:py-[28px] lg:h-[77px] box-border <?= ($key % 2 == 0) ? 'lg:pl-[122px] border-[rgba(59,161,124,0.4)]' : 'lg:pl-[50px] border-[rgba(246,136,27,0.4)]'; ?>"><?= $bottom_content_group_item_list_item['item']; ?></li>
                                                    <?php endforeach; ?>
                                                </ul>
                                            </div>
                                        </div>
            ...
            <div class="px-[33px] lg:px-0 max-w-[1180px] mx-auto">
                ...
                <div class="max-w-[180px] md:max-w-[398px] lg:max-w-[755px] mx-auto relative">
                    ...
                    <button id="ourProfessionalTeamPrevButton"
                            class="swiper-button-prev after:!content-none !block lg:!hidden absolute !left-[-64px] md:!left-[-119px] top-[50%] translate-y-[-50%] !w-[19px] !h-[19px] bg-transparent border-0 p-0">
                    ...
                    <button id="ourProfessionalTeamNextButton"
                            class="swiper-button-next after:!content-none !block lg:!hidden absolute !right-[-64px] md:!right-[-100px] top-[50%] translate-y-[-50%] !w-[19px] !h-[19px] bg-transparent border-0 p-0">
        ...
        <!--insights-->
        <section class="pt-[32px] md:pt-[48px] lg:pt-[73px] pb-[32px] md:pb-[48px] lg:pb-[88px]">
            <div class="px-[33px] md:px-0 md:max-w-[636px] lg:max-w-[1200px] mx-auto">
                <?php $insights_title = get_field('insights_title'); ?>
                <?php if ($insights_title) : ?>
                    <div class="mb-[24px] md:mb-[42px] text-center">
                        <span class="brand-text-gradient text-transparent bg-clip-text text-[24px] md:text-[26px] leading-[1.3] lg:text-[34px] lgleading-[1.27] font-[600]"><?= $insights_title; ?></span>
                    </div>
                <?php endif; ?>
                <?php $insights_list = get_field('insights_list'); ?>
                <?php if ($insights_list) : ?>
                    <div id="relatedInsights" class="swiper mb-[30px] lg:mb-[48px]">
                        <div class="swiper-wrapper lg:!grid lg:!grid-cols-3 lg:!gap-[24px] ">
                            <?php foreach ($insights_list as $insights_list_item): ?>
                                <a href="<?= get_permalink($insights_list_item); ?>" class="swiper-slide group">
                                    <div class="pb-[55.47%] rounded-[6px] mb-[16px] md:mb-[24px] lg:mb-[32px] overflow-hidden relative">
                                    ...
                                    <div class="text-[14px] md:text-[16px] leading-[1.65] text-[#393A40] lg:text-[24px] lg:leading-[1.27] lg:font-[500] mb-[8px] md:mb-[16px] lg:mb-[12px] opacity-80 lg:opacity-100">
                                        <?= get_the_title($insights_list_item); ?>
                                    </div>
                                    <div class="hidden lg:block text-[#393A40] text-[14px] leading-[1.65] md:text-[16px] opacity-[.8] md:mb-[16px]">
                                        <?= get_the_excerpt($insights_list_item); ?>
                                    </div>
                                    <span class="text-[#3BA17C] text-[16px] leading-[1.51] font-[500] uppercase lg:!normal-case">Read More</span>
                                </a>
                            <?php endforeach; ?>
                        </div>
                        <div class="lg:hidden swiper-pagination"></div>
                ...
                <?php if ($insights_button_text && $insights_button_link) : ?>
                    <div class="text-center">
                        <a href="<?= $insights_button_link; ?>"
                           class="inline-block pt-[13px] pb-[11px] px-[20px] lg:px-[70px] brand-button-gradient rounded-[3px] border-0 group relative"
                        >
                            <div class="absolute inset-0 group-hover:opacity-0 opacity-100 transition-opacity duration-500"
