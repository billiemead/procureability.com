                        ...
                        <div class="swiper-wrapper xl:!grid xl:!grid-cols-3 xl:!gap-[24px] ">
                            <?php foreach ($insights_list as $insights_list_item): ?>
                                <div class="swiper-slide group">
                                    ...
                                    <a href="<?= get_permalink($insights_list_item); ?>" class="text-[#3BA17C] text-[14px] xl:text-[16px] leading-[1.51] font-[500] xl:uppercase xl:!normal-case group-hover:underline underline-offset-[5px] group-hover:text-[#3BA17C] !decoration-dotted">Read More</a>
                                </div>
                            <?php endforeach; ?>
                        </div>
                        <div class="xl:hidden swiper-pagination"></div>
