                                    ...
                                    <?php if ($bottom_content_group_item_list) : ?>
                                        <div class="xl:w-[calc((572/1200)*100%)] <?= ($key % 2 == 0) ? 'xl:order-1' : null; ?>">
                                            <div class="relative">
                                                ...
                                                <ul class="py-[7px] xl:py-0 relative rounded-[5px] border border-solid border-[rgba(59,161,124,0.4)] text-[14px] md:text-[16px] xl:text-[18px] xl:border-0 list-none text-[18px] font-[500] xl:font-[600] leading-[1.2] m-0 <?= ($key % 2 == 0) ? 'text-[#3BA17C] border-[rgba(59,161,124,0.4)]' : 'text-[#F6881B] border-[rgba(246,136,27,0.4)]'; ?>">
                        ...
                        <div class="swiper-wrapper xl:!grid xl:!grid-cols-3 xl:!gap-[24px] ">
                            <?php foreach ($insights_list as $insights_list_item): ?>
                                <a href="<?= get_permalink($insights_list_item); ?>" class="swiper-slide group">
                                    <div class="pb-[55.47%] rounded-[6px] mb-[16px] md:mb-[24px] xl:mb-[32px] overflow-hidden relative">
                                    ...
                                    <div class="text-[14px] md:text-[16px] leading-[1.65] text-[#393A40] xl:text-[24px] xl:leading-[1.27] xl:font-[500] mb-[8px] md:mb-[16px] xl:mb-[12px] opacity-80 xl:opacity-100">
                                    ...
                                    <span class="text-[#3BA17C] text-[16px] leading-[1.51] font-[500] uppercase xl:!normal-case group-hover:underline underline-offset-[5px] decoration-dotted">Read More</span>
                                </a>
                            <?php endforeach; ?>
                        </div>
                        <div class="xl:hidden swiper-pagination"></div>
