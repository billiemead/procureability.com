...
<?php $clients_leading = get_field('clients_leading'); ?>
<?php $clients_clients = get_field('frontpage_industry_leader_in_procurement_clients', get_option('page_on_front')); ?>
