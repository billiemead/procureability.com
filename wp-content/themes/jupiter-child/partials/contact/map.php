...
<section class="py-[60px] relative">
    ...
    <div class="max-w-[1200px] mx-auto relative pointer-events-none">
        <div class="max-w-[300px] px-[15px] pointer-events-auto">
            <div class="pt-[32px] px-[32px] pb-[43px] bg-white rounded-[6px] shadow-[0px_4px_24px_rgba(0,0,0,0.1)] before:content-[''] before:h-[4px] before:block before:absolute before:top-0 before:left-0 before:w-full before:bg-[#0098AE] before:opacity-40 relative overflow-hidden">
                <?php if ($map_title) : ?>
                    <div class="mb-[16px]">
