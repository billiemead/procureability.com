...
<section
        class="pb-[235px] lg:pb-[108px] pt-[60px] md:pt-[125px] bg-no-repeat bg-[length:375px_auto] bg-[center_bottom] lg:bg-[calc(50%+375px)_bottom] xl:bg-[calc(50%+375px-80px)_bottom] lg:bg-[length:750px_auto]"
