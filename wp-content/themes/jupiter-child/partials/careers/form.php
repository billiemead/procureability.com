    ...
    <div class="relative px-[33px] md:px-0 md:max-w-[636px] xl:max-w-[1200px] mx-auto">
        <div class="xl:flex xl:justify-between">
            ...
            <div class="xl:w-[calc((555/1200)*100%)]">
                <div id="form"
                     class="relative font-poppins bg-white mx-[-22px] md:mx-0 md:rounded-[6px] shadow-[0px_3px_20px_rgba(57,58,64,0.1)] py-[32px] px-[35px] md:pt-[40px] md:pb-[48px] md:px-[78px] xl:px-[54px] xl:pt-[50px] xl:pb-[46px] box-border">
