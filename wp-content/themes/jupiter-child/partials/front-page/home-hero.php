            ...
            <div class="px-[34px] xl:max-w-[1200px] mx-auto">
                <div class="flex justify-center items-center">
                    ...
                    <a data-effect="mfp-zoom-out" href="<?= $frontpage_hero_ukraine_read_more_link['url']; ?>"
                       class="ukraine-popup-mfp font-poppins text-[#FFD700] text-[11px] xl:text-[14px] leading-[1.51] font-[500] transition-colors hover:text-white duration-500"><span><?= $frontpage_hero_ukraine_read_more_text; ?></span>
...
<?php if ($frontpage_hero_ukraine_popup_text) : ?>
    <div class="ukraine-popup mfp-hide" id="ukraine-popup"
         style="background-image: url(/wp-content/themes/jupiter-child/dist/img/pages/homepage/banner/popup-bg.jpg);">
