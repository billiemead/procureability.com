    ...
    <div class="relative px-[33px] md:px-0 md:max-w-[636px] xl:max-w-[1200px] mx-auto">
        <div class="xl:flex xl:justify-between">
            <div class="xl:w-[calc((595/1200)*100%)] mb-[24px] xl:mb-0">
                <div class="text-[24px] leading-[1.3] font-[500] mb-[16px] md:text-[34px] md:leading-[1.47] text-center xl:text-[36px] xl:leading-[1.38] xl:font-[600] xl:!text-left text-white xl:mb-[24px]"><?= $form_list_title; ?></div>
                <?php if ($form_list) : ?>
