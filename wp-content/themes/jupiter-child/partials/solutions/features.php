...
<?php if ($features) : ?>
    <section class="py-[80px]" x-data="{activeIndex: 0, numberOfItems: <?= count($features); ?>}">
        <div class="max-w-[1200px] mx-auto px-[34px] lg:px-[60px] relative box-border">
            <button class="hidden lg:flex justify-center items-center absolute top-[250px] left-[4px] w-[40px] h-[40px] rounded-full bg-transparent border border-[#393A40] border-solid text-[#393A40] hover:border-[rgba(97,99,107,0.3)] hover:text-[rgba(97,99,107,0.3)] transition-colors"
            ...
            <button class="hidden lg:flex justify-center items-center absolute top-[250px] right-[4px] w-[40px] h-[40px] rounded-full bg-transparent border border-[#393A40] border-solid text-[#393A40] hover:border-[rgba(97,99,107,0.3)] hover:text-[rgba(97,99,107,0.3)] transition-colors"
