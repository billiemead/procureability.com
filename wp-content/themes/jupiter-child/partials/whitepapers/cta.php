...
<section class="py-[40px] md:py-[56px] xl:py-[82px] relative bg-[#0098AE]">
    ...
    <div class="max-w-[636px] lg:max-w-[824px] px-[15px] lg:px-[34px] mx-auto relative">
        <div class="text-center mb-[24px] md:mb-[32px] xl:mb-[24px]">
            <div class="font-poppins text-white text-[22px] md:text-[26px] lg:text-[36px] leading-[1.4] md:leading-[1.3] xl:leading-[1.5] font-[600]"><?= $cta_pre_footer_title; ?></div>
        </div>
