...
<section
        class="pt-[48px] pb-[280px] lg:py-[138px] bg-[#F1F8F6] bg-no-repeat bg-[length:616px_auto] bg-[calc(50%+24px)_bottom] lg:bg-[length:1100px_auto] lg:bg-[calc(50%+550px-147px)_bottom]"
