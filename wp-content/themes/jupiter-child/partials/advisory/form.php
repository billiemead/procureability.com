...
$form_list_title = get_field('form_list_title');
$form_list = get_field('form_list');
$form_form_title = get_field('form_form_title');
                    ...
                    <ul class="list-none ml-0 text-[14px] leading-[1.7] text-white xl:leading-[1.6] opacity-80 xl:opacity-90 mb-0 space-y-[16px]">
                        <?php foreach ($form_list as $form_list_item) : ?>
                            <li class="relative pl-[23px] ml-0">
                                ...
                                <div class="font-poppins font-[400] text-[14px] xl:text-[18px] xl:leading-[1.5]"><?= $form_list_item['text']; ?></div>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                <?php endif; ?>
            ...
            <div class="xl:w-[calc((555/1200)*100%)]">
                <div id="form"
                    ...
                    <?php if ($form_form_title) : ?>
                        <div class="font-poppins text-[16px] md:text-[18px] xl:text-[20px] text-[#393A40] leading-[1.5] font-[500]  mb-[32px] text-center max-w-[400px] mx-auto"><?= $form_form_title; ?></div>
                    <?php endif; ?>
                    <?php if ($form_form) : ?>
