                    ...
                    <?php foreach ($insights_insights as $key => $insight) : ?>
                        <div>
                            <div class="group" style="perspective: 1000px;">
                                <div class="pt-[117.19%] relative group-hover:rotate-y-[180deg] transition-transform duration-[1750ms] transform-style-3d group-hover:delay-100 delay-500 ease-out">
                                    <!--back-->
