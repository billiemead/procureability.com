...
<section class="pt-[80px] pb-[100px]">
    <div class="max-w-[1200px] mx-auto px-[15px] lg:px-[34px]">
        <?php if ($insights_title) : ?>
            <div class="mb-[48px] text-center">
                <div class="font-poppins text-black text-[36px] leading-[1.35] font-semibold"><?= $insights_title; ?></div>
            </div>
        <?php endif; ?>
                ...
                <?php foreach ($insights_insights as $key => $insight) : ?>
                    <div>
                        <div class="group" style="perspective: 1000px;">
                            <div class="pt-[117.19%] relative group-hover:rotate-y-[180deg] transition-transform duration-500 transform-style-3d">
                                <!--back-->
