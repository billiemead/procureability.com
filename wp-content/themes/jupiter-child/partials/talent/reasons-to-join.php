...
<?php $reasons_to_join_advantages = get_field('reasons_to_join_advantages'); ?>
        ...
        <div class="xl:grid xl:grid-cols-2 xl:items-end xl:gap-[107px]">
            <div class="mb-[24px] md:mb-[40px] xl:mb-0">
                <img class="block w-full xl:max-w-full"
                     src="/wp-content/themes/jupiter-child/assets/img/pages/homepage/our-advantages.png"
                     alt="<?= $frontpage_our_advantages_title; ?>">
            </div>
            <?php if ($frontpage_our_advantages_advantages) : ?>
                <div class="relative">
                    ...
                    <div id="ourAdvantagesNavigationPrev"
                         class="xl:mt-[66px] absolute xl:!static left-[-20px] top-[115px] z-50 xl:translate-y-0 [&.swiper-button-disabled]:opacity-30 [&.swiper-button-disabled]:cursor-default [&:not(.swiper-button-disabled)]:hover:opacity-70 cursor-pointer xl:bg-[#cdeaf0] text-[#0098AE] h-[20px] w-[20px] xl:w-[60px] xl:h-[60px] rounded-full inline-flex justify-center items-center xl:mr-[10px]">
