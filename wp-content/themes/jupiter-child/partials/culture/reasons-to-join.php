...
<div class="relative" data-x-data="rtjCards">
    <section class="py-[40px] md:pt-[80px] md:pb-[50px]">
        <div class="max-w-[1200px] px-[34px] mx-auto">
            <div class="max-w-[870px] mx-auto mb-[40px]">
                <?php if ($reasons_to_join_title) : ?>
                    <div class="text-center mb-[8px]">
                        <div class="font-poppins brand-text-gradient text-transparent bg-clip-text text-[22px] md:text-[36px] leading-normal font-medium tracking-[-0.02em]"><?= $reasons_to_join_title; ?>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="text-center">
                        <a class="inline-block py-[12px] px-[38px] uppercase bg-[#3BA17C] rounded-[3px] group relative"
                           href="<?= $reasons_to_join_button['url']; ?>">
                            ...
                            ></div>
                            <span class="font-poppins text-white text-[18px] leading-[1.5] font-[700] tracking-[0.1em] font-[700]"><?= $reasons_to_join_button['title']; ?></span>
                        </a>
                    </div>
                <?php endif; ?>
            </div>
            <div class="grid gap-[4px] lg:gap-[10px] sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                <?php foreach ($reasons_to_join as $index => $reason_to_join) : ?>
                    <div>
                        <div class="rtj-card pt-[100%]" data-x-data="rtjCard" data-x-on:mouseleave="toggle"
                             data-x-on:mouseenter="toggle">
                            <div class="rtj-card-inner absolute inset-0" data-x-bind:class="{ 'active': active }">
                                <!--back-->
                                <div class="rotate-0 absolute inset-0 bg-[#e5f4f7] rtj-card-back py-[24px] px-[16px] overflow-hidden">
                                    <div class="relative z-20 w-full h-full overflow-auto">
                                        <div class="mb-[8px]">
                                            <span class="font-poppins text-[14px] leading-[1.7] tracking-[-0.01em] text-[#61636B] opacity-80"><?= $reason_to_join['excerpt']; ?></span>
                                        </div>
                                        <div>
                                ...
                                <div class="rotate-0 cursor-pointer absolute inset-0 rtj-card-front bg-center bg-cover overflow-hidden"
                                    ...
                                    <div class="!hidden absolute inset-0 p-[20px] flex flex-column justify-end">
        ...
        <div data-x-cloak data-x-transition.opacity data-x-show="modal"
            ...
            <div class="m-auto w-full max-w-[1320px] px-[15px] md:px-[60px] box-border relative">
                <div data-x-on:click.outside="toggleModal"
                     class="overflow-hidden rounded-[5px] bg-white md:bg-transparent shadow-[0px_3px_20px_rgba(57,58,64,0.1)] relative z-10">
