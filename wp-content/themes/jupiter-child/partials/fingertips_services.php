        ...
        <div class="fingertips-services__left d-flex">
            <?php foreach ($fields['images'] as $item) : ?>
                <a href="<?= $item['link'] ?>" class="fingertips-services__item vc_single_image-wrapper">
                    ...
                    <img src="<?= $item['image_on_hover']['url'] ?>" alt="<?= $item['image_on_hover']['alt'] ?>" class="on-hover">
                </a>
            <?php endforeach; ?>
        </div>

        <div class="fingertips-services__right" style="background-image: url('<?= $fields['right_image']['url'] ?>')"></div>
    </div>
<?php endif; ?>