...
<main class="pt-[25px] md:pt-[50px] pb-[100px] px-[15px] max-w-[960px] mx-auto positive-pressure-the-merits-of-sustainable-and-responsible-sourcing">
    ...
    <?php if ($statBoxShow): ?>
        <div class="mb-[32px] rounded-[7.25px] border border-solid border-[rgba(0,152,174,0.40)] bg-[#fff] px-[20px] py-[20px] text-[#393A40] font-poppins text-[16px] font-medium leading-[1.5] [&_sup]:relative [&_sup]:top-0 [&_sup]:text-[8px] [&_span]:text-[24px] [&_span]:text-[#0098AE]">
            <?= $statBoxText ?>
        </div>
    <?php endif; ?>
