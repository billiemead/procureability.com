        ...
        <div class="max-w-[1200px] mx-auto px-[15px]">
            ...
            <div>
                <a href="<?= $args['button_link'] ?>" target="_blank" class="inline-block py-[12px] px-[30px] bg-[#3BA17C] rounded-[3px] group relative" title="<?= $args['button_text'] ?>">
                    <div class="absolute inset-0 group-hover:opacity-0 opacity-100 transition-opacity duration-500 bg-no-repeat bg-center" style="background-image: url('https://procureability.com/wp-content/uploads/2024/01/button-bg-pattern.svg')"></div>
