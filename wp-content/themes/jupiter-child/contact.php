...
<?php get_header(); ?>
    <div class="bg-[#F7F9FA] bg-[left_calc(50%+250px)_top_-196px] bg-no-repeat lg:bg-[length:50%] lg:bg-[left_calc(50%+544px)_top_140px]"
         style="background-image: url('<?= get_stylesheet_directory_uri(); ?>/assets/img/star_pra.svg')">
