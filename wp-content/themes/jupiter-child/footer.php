...
<div id="footeraddon">
<!--
<div style="height:100px; width:100%; background:#EF8F53; padding-top: 15px; padding-bottom: 25px;  color: #ffffff;">
	<div><center><h2>Ready to Accelerate Savings & Procurement Performance?</h2><a href="https://procureability.com/contact/"><img src="https://procureability.com/wp-content/uploads/2018/11/contactus.png" width="150px"></center></a></div>

</div>
-->
</div>

<div id="mk-footer" class="<?php echo $mk_footer_class; ?>" <?php echo get_schema_markup( 'footer' ); ?>>
